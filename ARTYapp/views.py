...
from ARTYapp.forms import Profile_form, Project_form, Stock_form#, Stock_form
...
def update_profile(request, pk: int):
    ...
    return render(
        request=request,
        context=context_dict,
        template_name='templates/profesor_form.html'
    )
...
def delete_profile(request, pk: int):
    ...
    return render(
        request=request,
        context=context_dict,
        template_name='templates/profesor_confirm_delete.html'
    )
